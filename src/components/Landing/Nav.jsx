                            ...
                            <div className="flex flex-1 items-center sm:items-stretch sm:justify-between">
                                ...
                                <div className="hidden sm:ml-6 sm:block mt-10">
                                    <div className="flex space-x-4">
                                        {/* <DomLink to="/sign-in"> */}
                                            <button type="button" className="inline-flex border-2 border-white rounded-md bg-transparent 2xl:py-4 2xl:px-8 px-6 py-2.5 md:mt-2 2xl:md-1 text-white hover:text-black hover:bg-white gap-2 text-center " onClick={handleClickOpen}>
                                        ...
                                        {/* <DomLink to="/loan/signin"> */}
                                            <button type="button" className="inline-flex border-2 border-white rounded-md bg-white 2xl:py-4 2xl:px-8 px-4 py-2.5 md:mt-2 2xl:md-1 text-black gap-2 text-center items-center hover:bg-transparent hover:text-white" onClick={handleClickOpen}>
                                            Create Account
