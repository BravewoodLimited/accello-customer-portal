    ...
    <div className="px-4 pt-10 text-white bg-black">
      ...
      <div className="sm:flex gap-28 flex-row mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 justify-between sm:space-y-0 space-y-16">
        ...
        <div className="flex flex-col gap-y-6">
          ...
          <DomLink to={"/"}><p>Home</p></DomLink>
          <DomLink to={"/about-us"}><p>About Us</p></DomLink>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-y-6">
          <DomLink to="/privacy-policy"> <p>Terms and conditions</p></DomLink>
          <DomLink to="/terms-and-conditions"> <p>Privacy Policy</p></DomLink>
