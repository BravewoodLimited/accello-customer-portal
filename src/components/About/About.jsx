    ...
    <div className='p-4 text-black bg-landingbackground'>
        ...
        <div className='sm:flex gap-16 flex-row mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 sm:justify-between mt-8 items-center '>
                ...
                <div className='sm:max-w-[50%] mt-12'>
                    ...
                    <h1 className='lg:text-[36px] md:text-[36px] text-[36px] font-bold mb-5 leading-10'>We're A New Kind Of  <br /> Lending Company</h1>
                    ...
                    <p>At Accello, we're building a community where money worries don't hold you back from achieving your goals and dreams.
                      <br />
                      <br />
                      Need quick cash? We're here for you! With easy-to-get loans at the most competitive rates, whether you work for the government or a private company, we've got you covered. 
                      <br />
                      <br />
                      ...
                      We're not just another loan company. We're your partner in success, helping hardworking Nigerians like you take control of their finances. With Accello, your goals are within reach.
                      Quick, simple, and fair – that's the Accello way. Join thousands of satisfied customers and start your journey to financial freedom today.</p>
