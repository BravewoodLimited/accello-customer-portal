...
import { Accordion, AccordionSummary, AccordionDetails } from '../../custom/SecondCustomAccordion';
...
function Faqs(props) {
  ...
  return (
    <div className='p-4 text-black bg-background' name="Faqs">
        <div className=' mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 text-center mt-24'>
          <h1 className='font-NexaBold text-[36px]'>Frequently Asked Questions</h1>
        </div>
            ...
            <div className="relative overflow-x-auto sm:flex flex-row md:gap-[50px]">
                ...
                <div className='md:w-1/2'>
                    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                            <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600} >What is Accello?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                        ...
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What are the types of loans you give?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                        ...
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>Who is eligible to request?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>How can I get a loan?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What is the maximum amount I can get?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What is the loan tenure?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel7'} onChange={handleChange('panel7')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What are the loan requirements?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                            <ul className="list-disc">
                                ...
                                <li>A valid means of Identification (Driver's license, International passport or Voter's card)</li>
                ...
                <div className='md:w-1/2 '>
                    ...
                    <Accordion expanded={expanded === 'panel8'} onChange={handleChange('panel8')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What is a loan offer?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel9'} onChange={handleChange('panel9')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>How do I repay?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                        There are a few options all subject to your status
                        <ol className="list-decimal">
                            <li>Repayments can be set-off against your salary i.e deduction at source. This is taken directly from your employer.</li>
                            <li>You could set-up direct deduction on your bank account.</li>   
                            <li>You put your credit card on file for recurring debit.</li>
                        </ol>
                        </Typography>
                        </AccordionDetails>
                    </Accordion>
                    ...
                    <Accordion expanded={expanded === 'panel10'} onChange={handleChange('panel10')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What is the interest rate?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel11'} onChange={handleChange('panel11')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>Are there any charges?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                        Yes, there are charges. Though we do not charge interest, we charge monthly flat Upfees 
                        There is loan admin. and service charge of 2.5% 
                        </Typography>
                        </AccordionDetails>
                    </Accordion>
                    ...
                    <Accordion expanded={expanded === 'panel12'} onChange={handleChange('panel12')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>What happens if I default?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel13'} onChange={handleChange('panel13')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>Pre-payment penalties?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
                    ...
                    <Accordion expanded={expanded === 'panel14'} onChange={handleChange('panel14')}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                        <Typography fontSize={22} fontFamily={'NexaLight'} fontWeight={600}>Can I get a loan from anywhere in Nigeria?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Typography>
